...
export class TransactionControllerBase {
  ...
  async FundUserAccount(
    ...
    return this.service.FundUserAccount(body);
  }

  @common.Post("/transfer-user-funds")
  @swagger.ApiOkResponse({
    type: TransactionCreateInput,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async TransferUserFunds(
    ...
    return this.service.TransferUserFunds(body);
  }

  @common.Post("/withdraw-user-funds")
  @swagger.ApiOkResponse({
    type: TransactionCreateInput,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async WithdrawUserFunds(
    ...
    return this.service.WithdrawUserFunds(body);
  }
}

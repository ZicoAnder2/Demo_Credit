...
const CREATE_INPUT = {
  ...
  txnAmount: 42.42,
  txnCreatedAt: new Date(),
  txnDescription: "exampleTxnDescription",
  txnStatus: "exampleTxnStatus",
  txnType: "exampleTxnType",
  ...
  test("POST /transactions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        txnCreatedAt: CREATE_RESULT.txnCreatedAt.toISOString(),
      ...
      .expect([
        {
          ...
          txnCreatedAt: FIND_MANY_RESULT[0].txnCreatedAt.toISOString(),
  ...
  test("GET /transactions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        txnCreatedAt: FIND_ONE_RESULT.txnCreatedAt.toISOString(),

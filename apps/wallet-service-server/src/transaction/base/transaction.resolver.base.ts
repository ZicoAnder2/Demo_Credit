...
export class TransactionResolverBase {
  ...
  @graphql.Mutation(() => TransactionCreateInput)
  async FundUserAccount(
    @graphql.Args()
    args: TransactionCreateInput
  ): Promise<TransactionCreateInput> {
    return this.service.FundUserAccount(args);
  }
  ...
  async TransferUserFunds(
    ...
    return this.service.TransferUserFunds(args);
  }
  ...
  async WithdrawUserFunds(
    ...
    return this.service.WithdrawUserFunds(args);
  }
}
